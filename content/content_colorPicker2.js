...
//widnow height
canvas_colorPicker.style.marginTop = `${$(document).scrollTop()}px`;
zoom.style.marginTop = `${$(document).scrollTop()}px`;
cross.style.marginTop = `${$(document).scrollTop()}px`;

//adjusting cavnas when user scroll horizontally
canvas_colorPicker.style.marginLeft = `${$(document).scrollLeft()}px`;
zoom.style.marginLeft = `${$(document).scrollLeft()}px`;
cross.style.marginLeft = `${$(document).scrollLeft()}px`;
...
canvas_colorPicker.addEventListener("click", () => {
  ...
  whale.storage.local.set({ palette2: rgba }, function() {
